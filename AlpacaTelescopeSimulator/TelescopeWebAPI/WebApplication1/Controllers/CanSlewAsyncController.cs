...
namespace ASCOMCore.Controllers
{
    ...
    [ApiController]
    public class canslewasyncController : ControllerBase
    {
        ...
        public ActionResult<BoolResponse> Get(int ClientID, int ClientTransactionID)
        {
            try
            {
                bool CanSlewAsync = Program.Simulator.CanSlewAsync;
                Program.TraceLogger.LogMessage(methodName + " Get", CanSlewAsync.ToString());
